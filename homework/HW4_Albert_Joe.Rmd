...
However, one interesting rule I found was between 'curd, tropical fruit' and 'yogurt'. This rule has a lift of 3.69 and a confidence of 0.51. Although this was not an association I would typically expect, both the lift and confidence are high relative to the remainder of the associations. 

```{r grocery3}
inspect(head(rules_lift_filtered, n = 1000))
